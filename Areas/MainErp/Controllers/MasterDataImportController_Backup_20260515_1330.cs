...
namespace MyERP.Areas.MainErp.Controllers
{
    public class MasterDataImportController : MainErpControllerBase
    {
        ...
        public ActionResult Preview(string entityType, HttpPostedFileBase excelFile, bool stopOnAnyError = true, string importMode = MasterDataImportMode.Merge)
        {
            if (!CanUseImport())
            {
                return new HttpStatusCodeResult(403, "Only MainERP administrators can use master data import.");
