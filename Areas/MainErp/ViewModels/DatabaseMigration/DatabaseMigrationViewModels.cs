...
namespace MyERP.Areas.MainErp.ViewModels.DatabaseMigration
{
    public class DatabaseMigrationDashboardViewModel
    {
        public DatabaseMigrationDashboardViewModel()
        {
            ...
            ExecutionLog = new List<MigrationRunViewModel>();
        ...
        public IList<MigrationRunViewModel> ExecutionLog { get; set; }
    ...
    public class MigrationRunResult
    {
        public MigrationRunResult()
        {
            ...
            Skipped = new List<MigrationRunDetailViewModel>();
        ...
        public IList<MigrationRunDetailViewModel> Skipped { get; set; }
    ...
    public class MigrationPreviewViewModel
    {
        public MigrationFileInfoViewModel File { get; set; }
