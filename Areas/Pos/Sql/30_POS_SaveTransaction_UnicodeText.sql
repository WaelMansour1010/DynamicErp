...
BEGIN
    ...
    BEGIN TRY
        ...
        /*
            DEV_Serial is generated by counting vouchers for the business day.
            Take the day-level application lock before touching invoice/accounting rows
            to avoid deadlock cycles where concurrent saves hold different row locks
            then race for the same DEV serial lock.
        */
        ...
        BEGIN
            SET @AllocationError = N'Unable to allocate invoice accounting DEV_Serial. Source=sys.sp_getapplock; Resource=' + @DevSerialLockResource + N'; LockResult=' + CONVERT(NVARCHAR(20), @DevSerialLockResult) + N'; Stage=BeginTransaction';
