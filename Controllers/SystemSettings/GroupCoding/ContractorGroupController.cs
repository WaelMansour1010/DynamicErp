...
namespace MyERP.Controllers.SystemSettings.GroupCoding
{
    public class ContractorGroupController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return PartialView("~/Views/SystemSettings/GroupCoding/ContractorGroup/Index.cshtml");
        }
        ...
        public ActionResult AddEdit(int id = 0)
        {
            if (Session["MSERPtoken"] == null)
                return Content("<script>window.location = '/login/';</script>");
            ViewBag.ID = id;
            return PartialView("~/Views/SystemSettings/GroupCoding/ContractorGroup/AddEdit.cshtml");
        }
