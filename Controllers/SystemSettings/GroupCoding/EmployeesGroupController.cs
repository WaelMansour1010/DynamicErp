...
{
    public class EmployeesGroupController : Controller
    {
        // GET: Company
        public ActionResult Index()
        {
            ...
            return PartialView("~/Views/SystemSettings/GroupCoding/EmployeesGroup/Index.cshtml");
        }
        ...
        public ActionResult AddEdit(int id = 0)
        {
            if (Session["MSERPtoken"] == null)
                return Content("<script>window.location = '/login/';</script>");
            ViewBag.ID = id;
            return PartialView("~/Views/SystemSettings/GroupCoding/EmployeesGroup/AddEdit.cshtml");
        }
