...
Module: Shared
Purpose: Add service-invoice actual payment support used by main web cash receipt vouchers.
Safe to rerun? Yes
Dependencies: dbo.ServiceInvoice, dbo.CashReceiptVoucher, dbo.ERPUser, dbo.SalesInvoiceActualPayment, dbo.ServiceInvoicePaymentMethod
Date: 2026-05-19
Author/Agent: Codex
*/
