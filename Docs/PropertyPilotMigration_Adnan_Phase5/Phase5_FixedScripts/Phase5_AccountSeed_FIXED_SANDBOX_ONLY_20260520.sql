/* Phase5_AccountSeed_FIXED_SANDBOX_ONLY_20260520.sql */
...
BEGIN TRY
    ...
    SELECT @MigrationBatchId,N'Adnan',N'ACCOUNTS',ra.Account_Code,N'ChartOfAccount',ca.Id,N'Account',N'Phase5 fixed account seed'
    FROM RequiredAccounts ra
    ...
    SELECT @MigrationBatchId,N'Adnan',ra.Account_Code,ra.Account_ID,ra.Account_Name,ca.Id,ca.Code,N'Seed',1,N'Phase5 fixed account seed'
    FROM RequiredAccounts ra
    INNER JOIN dbo.ChartOfAccount ca ON ca.Code COLLATE DATABASE_DEFAULT = ra.Account_Code COLLATE DATABASE_DEFAULT
