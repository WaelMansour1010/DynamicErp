  ...
  public  class ToWord
    {
        ...
        public ToWord(Decimal number, string currency)
        {
            InitializeClass(number, currency, String.Empty, "only.", "فقط", "لا غير");
        }
        ...
        private void InitializeClass(Decimal number, string currency, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
            Number = number;
            CurrencyS = currency;
            EnglishPrefixText = englishPrefixText;
        ...
        private void ExtractIntegerAndDecimalParts()
        {
            ...
            if (splits.Length > 1)
                _decimalValue = Convert.ToInt32(splits[1]);
        ...
        public string ConvertToEnglish()
        {
            ...
            //formattedNumber += (retVal != String.Empty) ? (_intergerValue == 1 ? Currency.EnglishPluralCurrencyName : Currency.EnglishPluralCurrencyName) : String.Empty;
            formattedNumber += (retVal != String.Empty) ? (_intergerValue == 1 ? Currency.EnglishCurrencyName : Currency.EnglishCurrencyName) : String.Empty;
            ...
            formattedNumber += (decimalString != String.Empty) ? " " + (_decimalValue == 1 ? Currency.EnglishCurrencyPartName : Currency.EnglishCurrencyPartName) : String.Empty;
        ...
        public string ConvertToArabic()
        {
            ...
            formattedNumber += (retVal != String.Empty) ? retVal : String.Empty;
            // to add currency
            formattedNumber += (CurrencyS != String.Empty) ? CurrencyS : String.Empty;
            if (_intergerValue != 0)
