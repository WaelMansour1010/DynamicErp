namespace EazyCash.Models.TranslateToEnglish
{
    ...
    public class EnvBody
    {
        ...
        public TnsNamesTranslatorResponseElm tnsNamesTranslatorResponse_elm { get; set; }
    }
    ...
    public class EnglishTranslateRoot
    {
    ...
    public class TnsNamesTranslatorResponseElm
    {
