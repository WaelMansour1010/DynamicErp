...
namespace MyERP.Reporting.Reports {
    ...
    public partial class ReportDataSet : global::System.Data.DataSet {
        ...
        public partial class PropertyRenterDataTable : global::System.Data.TypedTableBase<PropertyRenterRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PropertyRenterRow AddPropertyRenterRow(string ArName, string EnName) {
        ...
        public partial class GetExpiredPropertyContractsDataTable : global::System.Data.TypedTableBase<GetExpiredPropertyContractsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public GetExpiredPropertyContractsRow FindByDetailID(int DetailID) {
                return ((GetExpiredPropertyContractsRow)(this.Rows.Find(new object[] {
                            DetailID})));
            }
        ...
        public partial class PropertyRenterRow : global::System.Data.DataRow {
            ...
            public string EnName {
                get {
                    try {
                        return ((string)(this[this.tablePropertyRenter.EnNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'EnName\' in table \'PropertyRenter\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePropertyRenter.EnNameColumn] = value;
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsEnNameNull() {
                return this.IsNull(this.tablePropertyRenter.EnNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetEnNameNull() {
                this[this.tablePropertyRenter.EnNameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace MyERP.Reporting.Reports.ReportDataSetTableAdapters {
    ...
    public partial class PropertyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            this._connection = new global::System.Data.SqlClient.SqlConnection();
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MyERP_ConnectionString"].ConnectionString;
        }
    ...
    public partial class PropertyRenterTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [PropertyRenter] ([ArName], [EnName]) VALUES (@ArName, @EnName)";
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [PropertyRenter] SET [ArName] = @ArName, [EnName] = @EnName WHERE (([id] =" +
                " @Original_id))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ArName", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ArName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@EnName", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "EnName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "Select id,ArName,EnName from PropertyRenter";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class DepartmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "Select id,ArName,EnName from Department";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
