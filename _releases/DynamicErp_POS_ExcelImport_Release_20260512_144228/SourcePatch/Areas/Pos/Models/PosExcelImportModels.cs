...
namespace MyERP.Areas.Pos.Models
{
    ...
    public class PosKycExcelPreviewRow
    {
        public int RowNumber { get; set; }
        public PosCustomerLookupDto Customer { get; set; }
        public string BranchCode { get; set; }
        public string BranchName { get; set; }
        public IList<string> Warnings { get; set; }

        public PosKycExcelPreviewRow()
        {
            Warnings = new List<string>();
        }
    }

    public class PosKycExcelCommitResult
    {
        public string Status { get; set; }
        public int ImportedCount { get; set; }
        public int FailedCount { get; set; }
        public IList<PosKycExcelCommitRowResult> Rows { get; set; }

        public PosKycExcelCommitResult()
        {
            Rows = new List<PosKycExcelCommitRowResult>();
        }
    }

    public class PosKycExcelCommitRowResult
    {
        public int RowNumber { get; set; }
