...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            AccountPaym, Account_DebitSide, Account_CreditSide, DateRec
        )
        VALUES
        (
            ...
            @partyAccount, CASE WHEN @noteType = 5 THEN @partyAccount ELSE @cashAccount END, CASE WHEN @noteType = 5 THEN @cashAccount ELSE @partyAccount END, GETDATE()
        );
    END
